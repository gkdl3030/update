...
<div>
학과
<input type="radio" name="major" value="창업마켓팅과"<?php if($majorprt =="창업마켓팅과") echo "checked";?>  >창업마켓팅과
<input type="radio" name="major" value="스마트웹콘텐츠과"<?php if($majorprt =="스마트웹콘텐츠과") echo "checked";?>  >스마트웹콘텐츠과
<input type="radio" name="major" value="소프트웨어개발과"<?php if($majorprt =="소프트웨어개발과") echo "checked";?> >소프트웨어개발과 <br>
</div>
<div>
주소
<select name="addr">
